    ...
    <div className="min-h-screen bg-pulseops-bg flex items-center justify-center px-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-heading font-bold text-pulseops-text">Create your account</h1>
          <p className="text-sm text-pulseops-muted mt-1">Start automating your incident response</p>
        </div>

        <div className="bg-pulseops-surface border border-pulseops-border rounded-2xl p-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-pulseops-text mb-1.5">Full Name</label>
              <input
                type="text"
                value={name}
            ...
            <div>
              ...
              <p className="text-xs text-pulseops-muted mt-1">Must be at least 8 characters</p>
            </div>
            <button
              type="submit"
              disabled={loading}
        ...
        <p className="text-center mt-6 text-sm text-pulseops-muted">
          ...
          <Link href="/auth/login" className="text-pulseops-cyan hover:text-pulseops-cyan/80 transition-colors font-medium">
            Sign in
          </Link>
        </p>
      </motion.div>
