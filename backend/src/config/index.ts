...
export const config = {
  ...
  mongoUri: process.env.MONGO_URI || process.env.DATABASE_URL || 'mongodb://localhost:27017/pulseops',
  redisUrl: process.env.REDIS_URL || 'redis://localhost:6379',
  jwtSecret: process.env.JWT_SECRET || 'pulseops-dev-jwt-secret-change-in-production',
  sessionSecret: process.env.SESSION_SECRET || 'pulseops-dev-session-secret',
  ...
  encryptionSecret: process.env.ENCRYPTION_SECRET || 'pulseops-dev-encryption-secret',
